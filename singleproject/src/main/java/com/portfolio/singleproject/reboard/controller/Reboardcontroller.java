...
public class Reboardcontroller {
	...
	public Object reboardEditpost(@ModelAttribute ReboardVO reboardVo,HttpSession session,
		...
		if(res>0) {
			...
			if(!reboardVo.getFilename().equals(vo.getFilename())) {
				...
				File delfile=new File(fileDelPath,vo.getFilename());
				boolean bool=false;
	...
	public Object replyGet(@RequestParam int no,Model model,HttpSession session) {
		...
		String replyOrigenBefore="<div id=\"pushTag_68f20c2efeb3ff7\" style=\"padding:0 0 0px 0;\" class=\"_wcpushTag\">&nbsp;</div><div class=\"wc_cite_wrapper\" style=\"font-family:굴림;font-size:10pt\"><br>\r\n" + 
				"<blockquote dir=\"ltr\" style=\"PADDING-RIGHT: 0px; PADDING-LEFT: 5px; MARGIN-LEFT: 5px; BORDER-LEFT: #000000 2px solid; MARGIN-RIGHT: 0px\"><font color=\"#0066CC\"><b>------ 원본 글 ------</b></font><br><br>";
		
		String replyOrigenAfter="<br>\r\n" + 
				"<div style=\"font-size:10pt; font-family:Gulim, sans-serif;\"><p><br></p><p>&nbsp;</p></div>\r\n" + 
				"</blockquote></div>";
		vo.setReboardContent(replyOrigenBefore+vo.getReboardContent()+replyOrigenAfter);
		vo.setReboardTitle("Re:"+vo.getReboardTitle());
		
		logger.info("vo.getReboardContent={}",vo.getReboardContent());
